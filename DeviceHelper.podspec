...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'git@github.com:shenjiafei/DeviceHelper.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shenjiafei' => '295417878@qq.com' }
  s.source           = { :git => 'git@github.com:shenjiafei/DeviceHelper.git', :tag => s.version.to_s }
